    ...
    <table>
        <thead>
            <tr>
                ...
                <th rowspan="2"
                style="background-color: #d1cdcc; text-align: center; padding: 8px; border: 1px solid black">Valor Aprobado</th>
                <th rowspan="2"
        ...
        <tbody>
            @foreach ($data as $row)
                <tr class="">
                    ...
                    <td style="text-align: center; padding: 8px;">{{ $row['value_approved'] }}</td>
